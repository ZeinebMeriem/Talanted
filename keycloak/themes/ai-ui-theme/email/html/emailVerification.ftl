...
<head>
  ...
  <title>Verify your email — AI UI Generator</title>
</head>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td style="padding:48px 48px 40px;">
                    ...
                    <!-- Title -->
                    <p style="margin:0 0 8px;font-size:24px;font-weight:700;color:#1e1b4b;letter-spacing:-0.3px;">Verify your email</p>
                    <p style="margin:0 0 28px;font-size:15px;color:#6b7280;line-height:1.6;">
                      Hi <strong style="color:#4338ca;">${user.firstName!user.username}</strong>,<br/>
                      Welcome to <strong>AI UI Generator</strong>! Click the button below to confirm your email address and activate your account.
                    </p>
                      ...
                      <tr>
                        <td style="background:#fefce8;border:1px solid #fde68a;border-radius:10px;padding:14px 18px;">
                          <p style="margin:0;font-size:13px;color:#92400e;">
                            ⏱ &nbsp;This link expires in <strong>${linkExpirationFormatter(linkExpiry)}</strong>. After that, you'll need to request a new verification email.
                          </p>
                        </td>
                      </tr>
                    </table>
                      ...
                      <tr>
                        <td style="background:#f9fafb;border-radius:10px;padding:16px 18px;">
                          <p style="margin:0;font-size:13px;color:#6b7280;">
                            🛡 &nbsp;<strong>Didn't create this account?</strong> Ignore this email — no account will be activated without clicking the link.
                          </p>
                        </td>
                      </tr>
                    </table>
